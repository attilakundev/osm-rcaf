...
def test_two_way_two_area_both_gap():
    file_path = f"{project_path}/test/files/results_multi_analyzer/false/two_way_two_area_gap_both.xml"
    file = open(file_path, "r").read()
    data = xmltodict.parse(file)
    assert 1 == 1
    error_information, correct_ways_count = analyzer.relation_checking(data)
...
def test_two_way_two_area_first_way_gap():
    file_path = f"{project_path}/test/files/results_multi_analyzer/false/two_way_two_area_gap_first_way.xml"
    file = open(file_path, "r").read()
    data = xmltodict.parse(file)
    error_information, correct_ways_count = analyzer.relation_checking(data)
    assert len(error_information) == 1
...
def test_two_way_two_area_second_way_gap():
    file_path = f"{project_path}/test/files/results_multi_analyzer/false/two_way_two_area_gap_second_way.xml"
    file = open(file_path, "r").read()
    data = xmltodict.parse(file)
    error_information, correct_ways_count = analyzer.relation_checking(data)
    assert len(error_information) == 1
...
def test_eight_way_two_area_gap_at_first():
    file_path = f"{project_path}/test/files/results_multi_analyzer/false/eight_way_two_area_gap_at_first.xml"
    file = open(file_path, "r").read()
    data = xmltodict.parse(file)
    error_information, correct_ways_count = analyzer.relation_checking(data)
    assert len(error_information) == 2
...
def test_eight_way_two_area_gap_at_second():
    file_path = f"{project_path}/test/files/results_multi_analyzer/false/eight_way_two_area_gap_at_second.xml"
    file = open(file_path, "r").read()
    data = xmltodict.parse(file)
    error_information, correct_ways_count = analyzer.relation_checking(data)
    assert len(error_information) == 2
